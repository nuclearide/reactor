...
export default class Cursors extends React.Component<{cursorPositions: {line: number, ch: number}[], visible: boolean}, any> {
    render() {
        return (
            <div className="reactor-cursors">
                {this.props.visible && this.props.cursorPositions.map((cursor, key) => {
